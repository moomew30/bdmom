const pages = [
  ...
  { label: "บทที่ 1 · วันแรกของเรา", html: `<section class="chapter"><div class="photo-wrap"><span class="tape"></span><div class="photo-placeholder"><img src="./images/img1.jpg" alt="รูป"></div></div><div><p class="eyebrow">บทที่หนึ่ง</p><h2>วันแรกของเรา</h2><p class="copy">ตั้งแต่วันแรกที่ผมลืมตาดูโลก แม่ก็เป็นคนแรกที่คอยอุ้มชู ดูแล และมอบความรักให้โดยไม่เคยขอสิ่งใดตอบแทน</p></div></section>` },
  { label: "บทที่ 2 · มือที่คอยประคอง", html: `<section class="chapter"><div class="photo-wrap"><span class="tape"></span><div class="photo-placeholder"><img src="./images/img2.jpg" alt="รูป"></div></div><div><p class="eyebrow">บทที่สอง</p><h2>มือที่คอยประคอง</h2><p class="copy">ทุกก้าวในวัยเด็กมีแม่อยู่ข้าง ๆ เสมอ วันที่ผมหกล้ม แม่คอยปลอบ วันที่ผมยิ้ม แม่ก็ยิ้มกว้างกว่าผมทุกครั้ง</p></div></section>` },
